...
export default class OrderService {
  ...
  /**
   * Internal helper used by the receipt confirm flow.
   * Skips public-API validation; caller is responsible for verified vendor/items.
   *
   * @param {{ vendorId: string, buyerId: string, items: Array, pesan?: string }} opts
   */
  static async createInternal({ vendorId, buyerId, items, pesan = "" }) {
